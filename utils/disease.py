disease_dic = {
    0: """ <b>Crop</b>: Apple <br/>Disease: Apple Scab<br/>
        <br/> Cause of disease:
    ...
    1: """ <b>Crop</b>: Apple <br/>Disease: Black Rot<br/>
        <br/> Cause of disease:
    ...
    2: """ <b>Crop</b>: Apple <br/>Disease: Cedar Apple Rust<br/>
        <br/> Cause of disease:
    ...
    3: """ <b>Crop</b>: Apple <br/>Disease: No disease<br/>
    ...
    4: """ <b>Crop</b>: Blueberry <br/>Disease: No disease<br/>
    ...
    5: """ <b>Crop</b>: Cherry <br/>Disease: Powdery Mildew<br/>
        <br/> Cause of disease:
    ...
    6: """ <b>Crop</b>: Cherry <br/>Disease: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",


    7: """ <b>Crop</b>: Corn <br/>Disease: Grey Leaf Spot<br/>
        <br/> Cause of disease:
    ...
    8: """ <b>Crop</b>: Corn(maize) <br/>Disease: Common Rust<br/>
        <br/> Cause of disease:
    ...
    9: """ <b>Crop</b>: Corn(maize) <br/>Disease: Northern Leaf Blight
        <br/>
        <br/> Cause of disease:
    ...
    10: """ <b>Crop</b>: Grape <br/>Disease: Black Rot<br/>
        <br/> Cause of disease:
    ...
    11: """ <b>Crop</b>: Corn(maize) <br/>Disease: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",


    12: """ <b>Crop</b>: Grape <br/>Disease: Black Measles<br/>
        <br/> Cause of disease:
    ...
    13: """ <b>Crop</b>: Grape <br/>Disease: Leaf Blight<br/>
        <br/> Cause of disease:
    ...
    14: """ <b>Crop</b>: Grape <br/>Disease: No disease<br/>
    ...
    15: """ <b>Crop</b>: Orange <br/>Disease: Citrus Greening<br/>
        <br/> Cause of disease:
    ...
    16: """ <b>Crop</b>: Peach <br/>Disease: Bacterial Spot<br/>
        <br/> Cause of disease:
    ...
    17: """ <b>Crop</b>: Pepper <br/>Disease: Bacterial Spot<br/>
        <br/> Cause of disease:
    ...
    18: """ <b>Crop</b>: Peach <br/>Disease: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    19: """ <b>Crop</b>: Pepper <br/>Disease: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",


    20: """ <b>Crop</b>: Potato <br/>Disease: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    21: """ <b>Crop</b>: Raspberry <br/>Disease: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",


    22: """ <b>Crop</b>: Soyabean <br/>Disease: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    23: """ <b>Crop</b>: Strawberry <br/>Disease: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    24: """ <b>Crop</b>: Tomato <br/>Disease: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",


   25: """ <b>Crop</b>: Potato <br/>Disease: Early Blight<br/>
        <br/> Cause of disease:
   ...
   26: """ <b>Crop</b>: Potato <br/>Disease: Late Blight<br/>
    ...
    27: """ <b>Crop</b>: Squash <br/>Disease: Powdery mildew<br/>
        <br/> Cause of disease:
    ...
    28: """ <b>Crop</b>: Strawberry <br/>Disease: Leaf Scorch<br/>
        <br/> Cause of disease:
    ...
    29: """ <b>Crop</b>: Tomato <br/>Disease: Bacterial Spot<br/>
        <br/> Cause of disease:
    ...
    30: """ <b>Crop</b>: Tomato <br/>Disease: Early Blight<br/>
        <br/> Cause of disease:
    ...
    31: """ <b>Crop</b>: Tomato <br/>Disease: Late Blight<br/>
    ...
    32: """ <b>Crop</b>: Tomato <br/>Disease: Leaf Mold<br/>
        <br/> Cause of disease:
    ...
    33: """ <b>Crop</b>: Tomato <br/>Disease: Leaf Spot<br/>
        <br/> Cause of disease:
    ...
    34: """ <b>Crop</b>: Tomato <br/>Disease: Two-spotted spider mite<br/>
        <br/> Cause of disease:
    ...
    35: """ <b>Crop</b>: Tomato <br/>Disease: Target Spot<br/>
        <br/> Cause of disease:
    ...
    36: """ <b>Crop</b>: Tomato <br/>Disease: Yellow Leaf Curl Virus<br/>
        <br/> Cause of disease:
    ...
    37: """ <b>Crop</b>: Tomato <br/>Disease: Mosaic Virus<br/>
        <br/> Cause of disease:
